...
class GSViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        buttonWXF.setBackgroundImage(UIImage.init(named: "MFWShare_wechat_session@2x.png"), for: UIControlState());
        ...
        buttonWXT.setBackgroundImage(UIImage.init(named: "MFWShare_wechat_timeline@2x.png"), for: UIControlState());
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        UIView.animate(withDuration: 0.5, delay: 0.15, options: UIViewAnimationOptions.allowUserInteraction, animations: {
        ...
        if WXI == true {
            ...
            UIView.animate(withDuration: 0.5, delay: 0.05, options: UIViewAnimationOptions.allowUserInteraction, animations: {
                self.buttonWXT.transform = CGAffineTransform.identity;
                }, completion: nil)
        }
        
        if QQI == true {
            UIView.animate(withDuration: 0.5, delay: 0.20, options: UIViewAnimationOptions.allowUserInteraction, animations: {
                self.buttonQQ.transform = CGAffineTransform.identity;
                }, completion: nil)
            UIView.animate(withDuration: 0.5, delay: 0.25, options: UIViewAnimationOptions.allowUserInteraction, animations: {
                self.buttonQzone.transform = CGAffineTransform.identity;
                }, completion: nil)
        }
        
        if WBI == true {
            UIView.animate(withDuration: 0.5, delay: 0.30, options: UIViewAnimationOptions.allowUserInteraction, animations: {
